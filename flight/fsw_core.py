...
Orchestrates the main execution loop (sensor polling, command execution, telemetry) 
and implements the 4-state FDIR machine (BOOT, NOMINAL, SAFE, CRITICAL).
Includes anti-oscillation guards and sub-3-second watchdog recovery.
"""
