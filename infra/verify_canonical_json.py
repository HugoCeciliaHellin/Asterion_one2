"""
Canonical JSON cross-compatibility verification script.
Generates reference hashes to prove Python and JavaScript produce identical 
canonical JSON and SHA-256 outputs for Ed25519 signing.
"""
