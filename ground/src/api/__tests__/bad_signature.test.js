 ...
 * Implements a factory pattern (createApp) with dependency injection (Knex DB, WebSocket gateway) 
 * to facilitate isolated testing. Serves endpoints at http://localhost:3000/api.
 */
